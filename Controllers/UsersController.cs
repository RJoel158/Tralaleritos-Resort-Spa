...
namespace ResortTralaleritos.Controllers
{
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,LastName,SecondLastName,Password,Email,Status")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,LastName,SecondLastName,Email,Status")] User user)
        {
            if (id != user.Id)
            {
                return NotFound();
